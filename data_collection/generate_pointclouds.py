"""
Script to generate point clouds of demonstrations from
...
Example:
    $ python generate_pointclouds.py --folder 1710610034_2530901
"""
...
if __name__ == "__main__":
    ...
    demo_path = os.path.join(os.getcwd(), "human_demonstrations/hdf5/") + args.folder
    ...
    for j in range(len(demos)):
        ...
        if args.use_actions: # Not useful for now
            ...
            for i in range(len(states)):
                directory = 'human_demonstrations/point_clouds/' + args.folder+ '/' + ep + '/'
                ...
                if i % 20 == 0:
                    ...
                    env4.sim.forward()
                    env1.render()
                    print(inspect.getmodule(type(env1)))
                    # env2.render()
                    # env3.render()
                    # env4.render()
                    ...
                    # xyz_world = np.vstack((env1_pointcloud, env3_pointcloud))
