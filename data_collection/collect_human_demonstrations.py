"""
Copied from robosuite utils

collect_human_demonstrations.py from robosuite scripts, appropriated for our purpose
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--directory",
        type=str,
        default=os.path.join(os.getcwd(), "human_demonstrations/hdf5"),
    )
    ...
    print(os.getcwd())
    tmp_directory = os.getcwd() + "/human_demonstrations/tmp/{}".format(str(time.time()).replace(".", "_"))
